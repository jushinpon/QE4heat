...
rm -f /home/jsp/2H-WTe2/QE4heat/crontab.log

cd /home/jsp/2H-WTe2/QE4heat && echo "$(date) - Running check_QEjobs4heating.pl"  >> /home/jsp/2H-WTe2/QE4heat/crontab.log 2>&1 && /usr/bin/perl /home/jsp/2H-WTe2/QE4heat/check_QEjobs4heating.pl >> /home/jsp/2H-WTe2/QE4heat/crontab.log 2>&1 && echo "$(date) - Running submit4newHeat.pl"  >> /home/jsp/2H-WTe2/QE4heat/crontab.log 2>&1 && /usr/bin/perl /home/jsp/2H-WTe2/QE4heat/submit4newHeat.pl  >> /home/jsp/2H-WTe2/QE4heat/crontab.log 2>&1
